...
module.exports = {
  ...
  async execute(sock, msg, args) {
    try {
      // REMOVED THE CRASHING LINE HERE
      // We will read the bot name directly from config or use a default string below
      ...
      // Safely fetch bot name from config if it exists, otherwise use 'the Bot'
